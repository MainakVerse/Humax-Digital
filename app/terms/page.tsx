      ...
      <section className="py-16 bg-[#FFFFFF]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl font-bold text-[#002A66] mb-4">1. Agreement to Terms</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#002A66] mb-4">2. Services</h2>
              <p className="text-[#002A66]/70 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#002A66] mb-4">3. Client Responsibilities</h2>
              <p className="text-[#002A66]/70 leading-relaxed mb-4">As a client, you agree to:</p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#002A66] mb-4">4. Payment Terms</h2>
              <p className="text-[#002A66]/70 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#002A66] mb-4">5. Intellectual Property</h2>
              <p className="text-[#002A66]/70 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#002A66] mb-4">6. Confidentiality</h2>
              <p className="text-[#002A66]/70 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#002A66] mb-4">7. Limitation of Liability</h2>
              <p className="text-[#002A66]/70 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#002A66] mb-4">8. Wikipedia Services Disclaimer</h2>
              <p className="text-[#002A66]/70 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#002A66] mb-4">9. Termination</h2>
              <p className="text-[#002A66]/70 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#002A66] mb-4">10. Governing Law</h2>
              <p className="text-[#002A66]/70 leading-relaxed">
