      ...
      <section className="py-16 bg-[#FFFFFF]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8">
            <div>
              <h2 className="text-2xl font-bold text-[#000000] mb-4">What Are Cookies?</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#000000] mb-4">How We Use Cookies</h2>
              ...
              <div className="space-y-6">
                <div className="p-6 bg-[#F8FAFC] border-l-4 border-[#0052CC]">
                  <h3 className="font-bold text-[#000000] mb-2">Essential Cookies</h3>
                  <p className="text-[#000000]/70 text-sm">
                    Required for the website to function properly. These cannot be disabled.
                  </p>
                </div>

                <div className="p-6 bg-[#F8FAFC] border-l-4 border-[#000000]">
                  <h3 className="font-bold text-[#000000] mb-2">Analytics Cookies</h3>
                  <p className="text-[#000000]/70 text-sm">
                ...
                <div className="p-6 bg-[#F8FAFC] border-l-4 border-[#000000]">
                  <h3 className="font-bold text-[#000000] mb-2">Functional Cookies</h3>
                  <p className="text-[#000000]/70 text-sm">
                ...
                <div className="p-6 bg-[#F8FAFC] border-l-4 border-[#000000]">
                  <h3 className="font-bold text-[#000000] mb-2">Marketing Cookies</h3>
                  <p className="text-[#000000]/70 text-sm">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#000000] mb-4">Cookies We Use</h2>
              <div className="border border-[#E2E8F0]">
                <table className="w-full text-sm">
                  <thead className="bg-[#F8FAFC]">
                    <tr>
                      <th className="text-left p-4 font-bold text-[#000000] border-b border-[#E2E8F0]">Cookie Name</th>
                      <th className="text-left p-4 font-bold text-[#000000] border-b border-[#E2E8F0]">Purpose</th>
                      <th className="text-left p-4 font-bold text-[#000000] border-b border-[#E2E8F0]">Duration</th>
                    </tr>
                  </thead>
                  <tbody className="text-[#000000]/70">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#000000] mb-4">Managing Cookies</h2>
              <p className="text-[#000000]/70 leading-relaxed mb-4">
              ...
              <p className="text-[#000000]/70 leading-relaxed mt-4">
                Please note that disabling certain cookies may affect the functionality of our website.
              </p>
            </div>

            <div>
              <h2 className="text-2xl font-bold text-[#000000] mb-4">Third-Party Cookies</h2>
              <p className="text-[#000000]/70 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#000000] mb-4">Updates to This Policy</h2>
              <p className="text-[#000000]/70 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#000000] mb-4">Contact Us</h2>
              <p className="text-[#000000]/70 leading-relaxed">
